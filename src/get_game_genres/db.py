...
from get_game_genres.config import DB_DIR_NAME, DB_FILE_NAME, DIR_BACKUP
from get_game_genres.common import process_list
from get_game_genres.third_party.shorten import shorten
